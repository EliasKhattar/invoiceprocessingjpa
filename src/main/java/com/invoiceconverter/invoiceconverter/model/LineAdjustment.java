...
@Setter
@Data
public class LineAdjustment extends InvoiceProcessing{
    ...
    @JoinColumn(name = "lineAdjustment_id")
    private ClassificationDetail lineAdjustment;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "invoiceLineAdjustment_id")
    private InvoiceLine invoiceLineAdjustment;
